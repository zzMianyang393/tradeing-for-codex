"""Merge bounded Williams %R audit batches into the frozen full-universe report."""
...
from daily_williams_r_range_reversion_audit import RULE_ID, summary, verdict
...
def merge(batch_paths: list[Path]) -> dict[str, Any]:
    ...
    if any(batch["rule_id"] != RULE_ID or batch["parameters"] != parameters for batch in batches):
    ...
    return {
        "report_type": "daily_williams_r_range_reversion_audit",
        "rule_id": RULE_ID,
