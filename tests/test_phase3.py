...
# Mock market module before importing anything that depends on it
# This avoids the Python 3.8 incompatibility with dataclass(slots=True)
mock_market = MagicMock()
sys.modules["market"] = mock_market

# Mock strategy module
mock_strategy = MagicMock()
sys.modules["strategy"] = mock_strategy
